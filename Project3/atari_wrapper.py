...
@PublicAPI
def wrap_deepmind(env, dim=84, clip_rewards=True, framestack=True, noframeskip=False):
    ...
    if clip_rewards is True: # updated by Yanhua
...
# noframeskip = True; when when using BreakoutNoFrameskip-v4